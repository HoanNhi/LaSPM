...
import static fi.tkk.ics.jbliss.Graph._add_edge;
import static fi.tkk.ics.jbliss.Graph._add_vertex;
import static fi.tkk.ics.jbliss.Graph.create;
import fi.tkk.ics.jbliss.pattern.JBlissPattern;
import fi.tkk.ics.jbliss.pattern.Edge;
import fi.tkk.ics.jbliss.pattern.LabeledNode;
...
public class Graph implements Serializable {
    ...
    private long createBliss() {
        List<LabeledNode> vertices = pattern.getVertices();
